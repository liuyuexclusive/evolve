...
func (c *userService) Test(ctx context.Context, in *TestRequest, opts ...client.CallOption) (*TestResponse, error) {
...
func (h *userHandler) Test(ctx context.Context, in *TestRequest, out *TestResponse) error {
